...
export function NotesGrid({ onNoteSelect, onUploadClick }: NotesGridProps) {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up animate-stagger-4">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={onUploadClick} variant="gradient" className="gap-2 animate-button">
      ...
      {notes.length === 0 ? (
        <Card className="p-12 text-center border-dashed animate-scale-in">
          <div className="flex flex-col items-center space-y-4">
            <div className="p-4 rounded-full bg-secondary animate-float">
              <BookOpen className="h-8 w-8 text-muted-foreground animate-pulse-glow" />
            </div>
            ...
            <Button onClick={onUploadClick} variant="gradient" className="animate-button animate-stagger-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {notes.map((note, index) => (
            <Card 
              key={note.id} 
              className={`cursor-pointer animate-card animate-fade-in-up group transition-all duration-200`}
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex space-x-2 pt-2">
                  <Button variant="outline" size="sm" className="flex-1 text-xs animate-button">
